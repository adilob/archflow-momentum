...
export const DiagnosticCTASection = () => {
      ...
      <div className="section-container">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold mb-4">
            {t("pages.diagnostic.ctaBand.title")}
          </h2>

          <p className="text-lg text-muted-foreground mb-8">
            {t("pages.diagnostic.ctaBand.body")}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {isExternal ? (
              ...
              >
                {t("pages.diagnostic.ctaBand.ctaPrimary")}
                <ArrowRight size={18} />
              </a>
            ) : (
              <Link
            ...
            >
              ...
              {t("pages.diagnostic.ctaBand.ctaSecondary")}
            </Link>
          </div>
        </motion.div>
      </div>
