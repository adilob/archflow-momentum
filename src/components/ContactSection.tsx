...
export const ContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: language === "pt" ? "Entraremos em contato em breve." : "We'll get back to you soon.",
    });
          ...
          <motion.div className="lg:col-span-2 flex flex-col justify-center" initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.2 }}>
            <div className="glass-card p-8 space-y-6">
              ...
              <div className="space-y-4">
                <a href="https://linkedin.com/company/archflow" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-4 rounded-lg bg-muted/50 hover:bg-muted transition-colors group">
                  <Linkedin size={24} className="text-primary" />
                  <div className="flex-1"><p className="font-medium text-sm">LinkedIn</p><p className="text-muted-foreground text-xs">@archflow</p></div>
